...
export default function DashboardPage() {
  ...
  return (
    <div className="h-full overflow-y-auto custom-scrollbar flex flex-col pb-16">
      ...
      <AnimatePresence>
        {toast && (
          <motion.div 
            ...
            className={cn(
              "fixed top-6 right-6 z-50 px-6 py-4 rounded-none flex items-center gap-3 border shadow-[0_24px_48px_rgba(0,0,0,0.1)] backdrop-blur-xl transition-all font-semibold text-sm",
              toast.type === 'success' 
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-blue-500/[0.02] blur-[150px] rounded-none -mr-64 -mt-64 pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-indigo-600/[0.02] blur-[120px] rounded-none -ml-32 -mb-32 pointer-events-none" />
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-10">
          ...
          <Link href="/dashboard/invoices">
            <motion.button 
              ...
              whileTap={{ scale: 0.98 }}
              className="bg-zinc-900 text-white px-6 py-3 rounded-none font-black text-xs hover:bg-zinc-800 transition-all flex items-center gap-2 shadow-none self-start sm:self-auto cursor-pointer"
            >
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 mt-4">
          ...
          <div className="xl:col-span-2 space-y-8">
            ...
            <motion.div
              ...
              className="p-6 lg:p-8 bg-white border border-black rounded-none shadow-none"
            >
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="bg-white border border-zinc-200 rounded-none pl-9 pr-4 py-2 text-xs text-zinc-800 placeholder-zinc-400 focus:outline-none focus:border-zinc-400 w-48 md:w-56 transition-all shadow-none"
                    />
                  </div>
                  
                  {/* Status Filters */}
                  <div className="flex items-center bg-zinc-100 p-0.5 rounded-none border border-zinc-200/50">
                    {['all', 'draft', 'sent', 'paid', 'overdue'].map((status) => (
                      <button
                        key={status}
                        onClick={() => setFilterStatus(status)}
                        className={cn(
                          "px-2.5 py-1.5 rounded-none text-[10px] font-black uppercase tracking-wider transition-all cursor-pointer",
                          filterStatus === status 
                            ? "bg-white text-zinc-900 font-bold shadow-none border border-zinc-200/20" 
                    ...
                    {loading ? (
                      ...
                      filteredInvoices.map((inv) => (
                        <tr key={inv.id} className="group hover:bg-zinc-50/50 transition-colors">
                          <td className="py-4 font-bold text-zinc-900 group-hover:text-zinc-600 transition-colors">
                            {inv.invoiceNumber}
                          </td>
                          ...
                          <td className="py-4">
                            <span className={cn(
                              "inline-block px-2.5 py-1 rounded-none text-[9px] font-black uppercase tracking-wider border",
            ...
            >
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="w-8 h-8 rounded-none bg-zinc-50 border border-zinc-100 flex items-center justify-center text-zinc-400">
                  <Mail size={16} />
                </div>
              </div>
              ...
              <div className="space-y-4">
                {loading ? (
                  ...
                  <div className="py-10 text-center border border-dashed border-black rounded-none">
                  ...
                  reminders.map((rem, index) => (
                    <motion.div
                      ...
                      className="p-4 bg-white border border-zinc-100 hover:bg-zinc-50/50 rounded-none flex items-center justify-between shadow-none transition-all group"
                    >
                      <div className="flex items-center gap-4">
                        <div className={cn(
                          "w-10 h-10 rounded-none flex items-center justify-center text-xs font-black border",
          ...
          <div className="space-y-8">
            ...
            <motion.div
              ...
              className="p-6 bg-rose-50/40 border border-rose-100 rounded-none relative overflow-hidden shadow-none"
            >
              {/* Pulse alert light */}
              <div className="absolute top-0 right-0 w-32 h-32 bg-rose-500/[0.01] blur-[50px] rounded-none pointer-events-none" />
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="w-10 h-10 rounded-none bg-rose-100 text-rose-600 border border-rose-200 flex items-center justify-center animate-pulse">
              ...
              <div className="space-y-4">
                {loading ? (
                  ...
                  <div className="py-8 text-center bg-white border border-zinc-150 rounded-none shadow-none">
                  ...
                  overdueInvoices.map((inv) => (
                    <div 
                      key={inv.id}
                      className="p-4 bg-white border border-rose-100 rounded-none flex flex-col gap-3 shadow-none group"
                    >
                      ...
                      <button
                        ...
                        className="w-full py-2 bg-rose-600 hover:bg-rose-700 text-white disabled:opacity-50 text-[10px] font-black uppercase tracking-wider rounded-none transition-all flex items-center justify-center gap-1.5 cursor-pointer shadow-none"
                      >
                        {remindingId === inv.id ? (
                          <>
            ...
            <motion.div
              ...
              className="p-6 bg-white border border-black rounded-none shadow-none relative overflow-hidden"
            >
              <div className="flex items-center justify-between mb-6">
                <div>
                ...
                <div className="flex items-center gap-1 bg-emerald-50 border border-emerald-100 text-emerald-600 text-[9px] font-black uppercase tracking-wider px-2 py-1 rounded-none">
                  <TrendingUp size={10} />
                  <span>+18.4%</span>
                </div>
              </div>
