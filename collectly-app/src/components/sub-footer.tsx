...
export const SubFooter = () => {
    return (
        <div className="w-full bg-black pt-8 pb-12 px-6">
            <div className="max-w-7xl mx-auto">
                <div className="bg-[#111111] rounded-2xl py-4 px-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl">
                    {/* Left: Location */}
