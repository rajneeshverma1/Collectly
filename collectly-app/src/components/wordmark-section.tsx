    ...
    return (
        <section className="relative w-full h-[300px] md:h-[450px] overflow-hidden select-none pointer-events-none" style={{ backgroundColor: '#0B0B0F' }}>
            ...
            <div className="absolute inset-x-0 bottom-0 top-0 flex items-end justify-center z-20 pb-10 md:pb-20">
                ...
                >
                    <span className="text-[80px] sm:text-[140px] md:text-[20vw] lg:text-[18vw] font-semibold tracking-[-0.08em] leading-[0.8] whitespace-nowrap bg-clip-text text-transparent bg-gradient-to-b from-white/30 via-white/10 to-transparent">
                        Collectly.ai
                    </span>
                    {/* Giant Green Dot */}
                    <div className="w-4 h-4 sm:w-10 sm:h-10 md:w-[3.5vw] md:h-[3.5vw] bg-green-400 rounded-full mb-1 sm:mb-2 md:mb-[0.7vw] ml-0.5 sm:ml-1 md:ml-[0.7vw] shadow-[0_0_60px_rgba(74,222,128,0.7)]" />
                </motion.div>
            </div>
